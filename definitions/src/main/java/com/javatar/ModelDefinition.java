...
import com.javatar.model.CircularAngle;
import com.javatar.model.FaceNormal;
import com.javatar.model.ModelPatch;
import com.javatar.model.VertexNormal;
...
public class ModelDefinition implements Definition {
    ...
    public transient List<ModelPatch> textureModelPatches = new ArrayList<>();
    public transient List<ModelPatch> colorModelPatches = new ArrayList<>();
    public transient byte[] rawModelData;
    private transient int[][] vertexGroups;

    /*
    Custom fields for re-encoding parts of the model
     */
